...
from net.BiLSTMSrl import SpanSrlNet
...
def main():
    ...
    model = SpanSrlNet(
        ...
        label_i2l=None,#srl_data_module.dataset.label_i2l,
        lr=lr,
        weight_decay=weight_decay)

    # path = "models/srl-bilstm-crf-256-16-epoch=22-f1_score=75.0565.ckpt"
    # check_point = torch.load(path)
    # model.load_state_dict(check_point["state_dict"])
    # torch.save(model.state_dict(), "./srl-bilstm.model")

    path = "./srl-bilstm.model"
