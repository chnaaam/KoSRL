...
def main():
    ...
    path = "models/srl-non-crf-focal-loss-biaffine-crf-mean-(-3)-fc2-256-16-epoch=6-f1_score=75.0877.ckpt"
    check_point = torch.load(path)
    model.load_state_dict(check_point["state_dict"])
    torch.save(model.state_dict(), "./srl-non-crf.model")

    path = "./srl-non-crf.model"
