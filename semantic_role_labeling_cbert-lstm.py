...
from net.conditional_bert_lstm import ConditionalBert
...
def main():
    ...
    checkpoint_callback = ModelCheckpoint(
        monitor="acc",
        dirpath=model_path,
        filename=f"srl-conditional-bert-lstm-l3-with-confidence-score-{max_length}-{precision}-" + "{epoch}-{acc:0.4f}",
        save_top_k=2,
        mode="max")
