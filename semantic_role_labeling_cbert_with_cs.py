...
from net.conditional_bert_with_confidence_score import ConditionalBert
...
def main():
    ...
    checkpoint_callback = ModelCheckpoint(
        monitor="acc",
        dirpath=model_path,
        filename=f"srl-conditional-bert-wit-score-ce-{max_length}-{precision}-" + "{epoch}-{acc:0.4f}",
        save_top_k=2,
        mode="max")
